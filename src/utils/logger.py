...
class Logger:
    ...
    def __init__(self, out_path, extreme_loss_factor, window_size_cycles):
        self.step_stats_file = open(out_path + "step_stats.txt", "a", buffering=1, encoding="utf-8")
        self.records_file = open(out_path + "records.txt", "a", buffering=1, encoding="utf-8")
        self.extreme_loss_file = open(out_path + "extreme_losses.txt", "a", buffering=1, encoding="utf-8")
        ...
        self.log_file = open(out_path + "log.txt", "a", buffering=1, encoding="utf-8")
