...
- Wins: 110
- Win rate: 0.419847
- Average return: 3.91376
- Average score: 25855.2
- Train level pool / coverage: filtered / 145/200 (0.725)
- Learning updates: 250
- Loss first/last/min/max: 7.44433 / 1.39532 / 0.51 / 7.5478
- Last epsilon: 0.0486341
- Last action/angle/tap entropy: 1.55277 / 1.43602 / 1.12043
- ConvNeXt image feature std min/mean: 0.573847 / 0.795287
- ConvNeXt fine-tune status: backbone_frozen_until_scheduled_finetune; backbone grad norm last/mean: 0 / 0
- QR status: qr_quantiles_logged; quantiles: 51; std mean: 2.02906; p90-p10 spread mean: 5.1414
...
- Low epsilon plus NoisyNet exploration: last epsilon 0.0486341
- Scheduled ConvNeXt fine-tuning: backbone_frozen_until_scheduled_finetune
- Proxy reward shaping: not_proxy_reward_run
- All-map training pool: partial_map_coverage
- Action/tap usage: action entropy 1.55277, tap entropy 1.12043
